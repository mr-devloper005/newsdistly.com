            ...
            <div>
              <div className="h-full bg-[var(--slot4-dark-bg)] p-7 text-white sm:p-10 lg:p-14">
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-2">
                  {['Press releases', 'Campaigns', 'Industries', 'Publishers'].map((item) => (
                    <div key={item} className="border border-white/12 bg-white/6 px-4 py-3 text-xs font-black uppercase tracking-[0.16em] text-white/78">{item}</div>
                  ))}
                </div>
              </div>
            </div>
            <form action="/search" className="self-center p-6 sm:p-10 lg:p-14">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-2">
                <label className="flex items-center gap-2 border border-black bg-white px-4 py-3">
                  ...
                  <input name="category" defaultValue={category} placeholder="Industry or category" className="min-w-0 flex-1 bg-transparent text-sm font-bold outline-none placeholder:text-current/35" />
                </label>
